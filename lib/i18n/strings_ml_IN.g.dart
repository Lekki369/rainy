...
class TranslationsMlIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'വിശ്വസനീയമായ വിജറ്റ് അപ്‌ഡേറ്റുകൾക്ക് ആപ്പ് settings-ൽ Rainy-ന്റെ ബാറ്ററി പരിമിതം ഓഫ് ചെയ്യുക';
...
extension on TranslationsMlIn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'വിശ്വസനീയമായ വിജറ്റ് അപ്‌ഡേറ്റുകൾക്ക് ആപ്പ് settings-ൽ Rainy-ന്റെ ബാറ്ററി പരിമിതം ഓഫ് ചെയ്യുക',
