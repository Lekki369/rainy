...
class TranslationsHiIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'विश्वसनीय विजेट अपडेट के लिए ऐप सेटिंग्स में Rainy की बैटरी अनुकूलन बंद करें';
...
extension on TranslationsHiIn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'विश्वसनीय विजेट अपडेट के लिए ऐप सेटिंग्स में Rainy की बैटरी अनुकूलन बंद करें',
