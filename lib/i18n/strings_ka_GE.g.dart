...
class TranslationsKaGe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'ვიჯეტის საიმედო განახლებისთვის გამორთეთ Rainy-ის ბატარეის ოპტიმიზაცია აპის პარამეტრებში';
...
extension on TranslationsKaGe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'ვიჯეტის საიმედო განახლებისთვის გამორთეთ Rainy-ის ბატარეის ოპტიმიზაცია აპის პარამეტრებში',
