...
class TranslationsItIt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Per aggiornamenti affidabili del widget, disattiva l\'ottimizzazione batteria per Rainy nelle impostazioni dell\'app';
...
extension on TranslationsItIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Per aggiornamenti affidabili del widget, disattiva l\'ottimizzazione batteria per Rainy nelle impostazioni dell\'app',
