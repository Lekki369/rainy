...
class TranslationsTaIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'நம்பகமான விட்ஜெட் புதுப்பிப்புகளுக்கு, ஆப் settings-ல் Rainy-க்கான battery கட்டுப்பாட்டை அணைக்கவும்';
...
extension on TranslationsTaIn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'நம்பகமான விட்ஜெட் புதுப்பிப்புகளுக்கு, ஆப் settings-ல் Rainy-க்கான battery கட்டுப்பாட்டை அணைக்கவும்',
