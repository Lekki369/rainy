...
class TranslationsMrIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'विश्वासार्ह विजेट अपडेटसाठी ॲप सेटिंग्जमध्ये Rainy साठी बॅटरी निर्बंध बंद करा';
...
extension on TranslationsMrIn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'विश्वासार्ह विजेट अपडेटसाठी ॲप सेटिंग्जमध्ये Rainy साठी बॅटरी निर्बंध बंद करा',
