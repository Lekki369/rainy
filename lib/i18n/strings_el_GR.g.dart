...
class TranslationsElGr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Για αξιόπιστες ενημερώσεις widget, απενεργοποιήστε τη βελτιστοποίηση μπαταρίας για το Rainy στις ρυθμίσεις της εφαρμογής';
...
extension on TranslationsElGr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Για αξιόπιστες ενημερώσεις widget, απενεργοποιήστε τη βελτιστοποίηση μπαταρίας για το Rainy στις ρυθμίσεις της εφαρμογής',
