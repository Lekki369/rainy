...
class TranslationsUrPk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'قابلِ اعتماد ویجٹ اپ ڈیٹس کے لیے ایپ کی ترتیبات میں Rainy کی بیٹری پابندی بند کریں';
...
extension on TranslationsUrPk {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'قابلِ اعتماد ویجٹ اپ ڈیٹس کے لیے ایپ کی ترتیبات میں Rainy کی بیٹری پابندی بند کریں',
