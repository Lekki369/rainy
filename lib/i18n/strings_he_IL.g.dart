...
class TranslationsHeIl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'לעדכוני ווידג\'ט אמינים, השבת אופטימיזציית סוללה עבור Rainy בהגדרות האפליקציה';
...
extension on TranslationsHeIl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'לעדכוני ווידג\'ט אמינים, השבת אופטימיזציית סוללה עבור Rainy בהגדרות האפליקציה',
