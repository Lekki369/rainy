...
class TranslationsDeDe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Für zuverlässige Widget-Aktualisierungen deaktivieren Sie die Akku-Optimierung für Rainy in den App-Einstellungen';
...
extension on TranslationsDeDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Für zuverlässige Widget-Aktualisierungen deaktivieren Sie die Akku-Optimierung für Rainy in den App-Einstellungen',
