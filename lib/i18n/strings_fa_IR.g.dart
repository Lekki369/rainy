...
class TranslationsFaIr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'برای به‌روزرسانی پایدار ویجت، بهینه‌سازی باتری Rainy را در تنظیمات برنامه غیرفعال کنید';
...
extension on TranslationsFaIr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'برای به‌روزرسانی پایدار ویجت، بهینه‌سازی باتری Rainy را در تنظیمات برنامه غیرفعال کنید',
