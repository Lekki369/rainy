...
class TranslationsArSa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'لتحديثات موثوقة للأداة، عطّل تحسين البطارية لتطبيق Rainy في إعدادات التطبيق';
...
extension on TranslationsArSa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'لتحديثات موثوقة للأداة، عطّل تحسين البطارية لتطبيق Rainy في إعدادات التطبيق',
