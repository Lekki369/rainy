...
class TranslationsHuHu extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Megbízható widget-frissítéshez kapcsolja ki a Rainy akkumulátor-optimalizálását az alkalmazás beállításaiban';
...
extension on TranslationsHuHu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Megbízható widget-frissítéshez kapcsolja ki a Rainy akkumulátor-optimalizálását az alkalmazás beállításaiban',
