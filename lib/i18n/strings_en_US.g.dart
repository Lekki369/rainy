...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	/// en-US: 'Rainy showers'
	String get heavy_rains => 'Rainy showers';
	...
	/// en-US: 'Freezing Rainy'
	String get freezing_rain => 'Freezing Rainy';
	...
	/// en-US: 'For reliable widget updates, disable battery optimization for Rainy in app settings'
	String get widget_battery_hint => 'For reliable widget updates, disable battery optimization for Rainy in app settings';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'For reliable widget updates, disable battery optimization for Rainy in app settings',
