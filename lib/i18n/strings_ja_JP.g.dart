...
class TranslationsJaJp extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'ウィジェットを確実に更新するには、アプリ設定で Rainy のバッテリー最適化を無効にしてください';
...
extension on TranslationsJaJp {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'ウィジェットを確実に更新するには、アプリ設定で Rainy のバッテリー最適化を無効にしてください',
