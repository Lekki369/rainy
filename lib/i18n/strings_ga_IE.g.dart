...
class TranslationsGaIe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Le haghaidh nuashonruithe iontaofa giuirléid, díchumasaigh optamú ceallraí do Rainy sna socruithe aipe';
...
extension on TranslationsGaIe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Le haghaidh nuashonruithe iontaofa giuirléid, díchumasaigh optamú ceallraí do Rainy sna socruithe aipe',
