...
class TranslationsSkSk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Pre spoľahlivé aktualizácie widgetu vypnite optimalizáciu batérie pre Rainy v nastaveniach aplikácie';
...
extension on TranslationsSkSk {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Pre spoľahlivé aktualizácie widgetu vypnite optimalizáciu batérie pre Rainy v nastaveniach aplikácie',
