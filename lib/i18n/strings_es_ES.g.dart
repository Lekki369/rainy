...
class TranslationsEsEs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Para actualizaciones fiables del widget, desactiva la optimización de batería de Rainy en los ajustes de la aplicación';
...
extension on TranslationsEsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Para actualizaciones fiables del widget, desactiva la optimización de batería de Rainy en los ajustes de la aplicación',
