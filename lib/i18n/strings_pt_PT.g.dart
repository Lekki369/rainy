...
class TranslationsPtPt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Para atualizações fiáveis do widget, desative a otimização da bateria para Rainy nas definições da aplicação';
...
extension on TranslationsPtPt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Para atualizações fiáveis do widget, desative a otimização da bateria para Rainy nas definições da aplicação',
