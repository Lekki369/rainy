...
class TranslationsNlNl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Schakel voor betrouwbare widget-updates batterijoptimalisatie voor Rainy uit in de app-instellingen';
...
extension on TranslationsNlNl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Schakel voor betrouwbare widget-updates batterijoptimalisatie voor Rainy uit in de app-instellingen',
