...
class TranslationsRoRo extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Pentru actualizări fiabile ale widgetului, dezactivați optimizarea bateriei pentru Rainy în setările aplicației';
...
extension on TranslationsRoRo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Pentru actualizări fiabile ale widgetului, dezactivați optimizarea bateriei pentru Rainy în setările aplicației',
