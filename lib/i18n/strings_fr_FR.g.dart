...
class TranslationsFrFr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Pour des mises à jour fiables du widget, désactivez l\'optimisation de la batterie pour Rainy dans les paramètres de l\'application';
...
extension on TranslationsFrFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Pour des mises à jour fiables du widget, désactivez l\'optimisation de la batterie pour Rainy dans les paramètres de l\'application',
