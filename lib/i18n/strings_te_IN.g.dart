...
class TranslationsTeIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'నమ్మకమైన విడ్జెట్ నవీకరణల కోసం యాప్ సెట్టింగ్‌లలో Rainy కోసం బ్యాటరీ పరిమితిని నిలిపివేయండి';
...
extension on TranslationsTeIn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'నమ్మకమైన విడ్జెట్ నవీకరణల కోసం యాప్ సెట్టింగ్‌లలో Rainy కోసం బ్యాటరీ పరిమితిని నిలిపివేయండి',
