...
class TranslationsRuRu extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Для стабильного обновления виджета отключите оптимизацию батареи для Rainy в настройках приложения';
...
extension on TranslationsRuRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Для стабильного обновления виджета отключите оптимизацию батареи для Rainy в настройках приложения',
