...
class TranslationsPtBr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'Para atualizações confiáveis do widget, desative a otimização de bateria do Rainy nas configurações do app';
...
extension on TranslationsPtBr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'Para atualizações confiáveis do widget, desative a otimização de bateria do Rainy nas configurações do app',
