...
class TranslationsBnIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'নির্ভরযোগ্য উইজেট আপডেটের জন্য অ্যাপ সেটিংসে Rainy-এর ব্যাটারি অপ্টিমাইজেশন বন্ধ করুন';
...
extension on TranslationsBnIn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'নির্ভরযোগ্য উইজেট আপডেটের জন্য অ্যাপ সেটিংসে Rainy-এর ব্যাটারি অপ্টিমাইজেশন বন্ধ করুন',
