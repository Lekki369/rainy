...
class TranslationsDaDk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get widget_battery_hint => 'For pålidelige widget-opdateringer skal du deaktivere batterioptimering for Rainy i appindstillingerne';
...
extension on TranslationsDaDk {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'widget_battery_hint' => 'For pålidelige widget-opdateringer skal du deaktivere batterioptimering for Rainy i appindstillingerne',
