...
///
/// Must match the App Group capability enabled on both the app and the iOS
/// widget extension target, and stay in sync with the bundle id. Apple requires
/// the `group.` prefix.
const String appGroupId = 'group.com.example.rainy';
