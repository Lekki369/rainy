...
/// All Rainy home-screen widgets registered in the app.
///
...
const List<WidgetDefinition> rainWidgetRegistry = [
  WidgetDefinition(
    ...
    qualifiedAndroidName:
        'com.example.rainy.widget.providers.WidgetMaterialYouForecast1x1Provider',
  ...
  WidgetDefinition(
    ...
    qualifiedAndroidName:
        'com.example.rainy.widget.providers.WidgetMaterialYouCurrentProvider',
  ...
  WidgetDefinition(
    ...
    qualifiedAndroidName:
        'com.example.rainy.widget.providers.WidgetClockDayHorizontalProvider',
