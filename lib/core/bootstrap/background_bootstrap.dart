...
const _legacyForecastChannelIds = ['Rainy', 'RainSound'];

/// Removes obsolete Android channels so users are not stuck with sound-enabled [Rainy].
///
...
Future<void> initializeNotificationsPlugin() async {
  try {
    const initializationSettings = InitializationSettings(
      ...
      linux: LinuxInitializationSettings(defaultActionName: 'Rainy'),
    );
