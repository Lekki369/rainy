...
import 'package:rainy/core/settings/clock_skew_persistence.dart';
import 'package:rainy/core/services/connectivity_service.dart';
import 'package:rainy/core/services/network_cache_handler.dart';
import 'package:rainy/core/utils/async_queue.dart';
import 'package:rainy/core/utils/debug_log.dart';
import 'package:rainy/core/utils/parallel_runner.dart';
import 'package:rainy/features/cities/domain/cities_load_resolver.dart';
import 'package:rainy/features/cities/domain/weather_card_validator.dart';
...
class CitiesNotifier extends Notifier<CitiesState> {
  ...
  Future<void> _loadImpl() async {
    final revision = _cardsRevision;
    try {
      final result = CitiesLoadResolver.resolve(
        fromDb: await _repo.getAllSorted(),
      );
      if (revision != _cardsRevision) {
        state = state.copyWith(isLoading: false, loadError: false);
        return;
      }
